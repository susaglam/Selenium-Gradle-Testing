...
public class Assignment {
    private static final long shortTimeout = 10;

    private static final long longTimeout = 90;
    ...
    public void closeDialog(WebDriver driver) {
        ...
        try {
            // close google dialog box
            shortWait.until(ExpectedConditions.elementToBeClickable(By.id("L2AGLb"))).click();
